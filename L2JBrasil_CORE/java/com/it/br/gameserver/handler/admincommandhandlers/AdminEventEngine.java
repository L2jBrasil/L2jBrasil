...
public class AdminEventEngine implements IAdminCommandHandler {
    ...
    public AdminEventEngine() {
        admin.put("admin_event", Config.admin_event);
        admin.put("admin_event_new", Config.admin_event_new);
        admin.put("admin_event_choose", Config.admin_event_choose);
        admin.put("admin_event_store", Config.admin_event_store);
        admin.put("admin_event_set", Config.admin_event_set);
        admin.put("admin_event_change_teams_number", Config.admin_event_change_teams_number);
        admin.put("admin_event_announce", Config.admin_event_announce);
        admin.put("admin_event_panel", Config.admin_event_panel);
        admin.put("admin_event_control_begin", Config.admin_event_control_begin);
        admin.put("admin_event_control_teleport", Config.admin_event_control_teleport);
        admin.put("admin_add", Config.admin_add);
        admin.put("admin_event_see", Config.admin_event_see);
        admin.put("admin_event_del", Config.admin_event_del);
        admin.put("admin_delete_buffer", Config.admin_delete_buffer);
        admin.put("admin_event_control_sit", Config.admin_event_control_sit);
        admin.put("admin_event_name", Config.admin_event_name);
        admin.put("admin_event_control_kill", Config.admin_event_control_kill);
        admin.put("admin_event_control_res", Config.admin_event_control_res);
        admin.put("admin_event_control_poly", Config.admin_event_control_poly);
        admin.put("admin_event_control_unpoly", Config.admin_event_control_unpoly);
        admin.put("admin_event_control_prize", Config.admin_event_control_prize);
        admin.put("admin_event_control_chatban", Config.admin_event_control_chatban);
        admin.put("admin_event_control_finish", Config.admin_event_control_finish);
    }
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar)
    {
        ...
        if (command.equals("admin_event")) showMainPage(activeChar);
            ...
            while (st1.hasMoreElements()) {
                polyTeam(Integer.parseInt(st1.nextToken()), id);
            }
            showEventControl(activeChar);
            ...
            StringTokenizer st2 = new StringTokenizer(st0.nextToken(), "-");
            ...
            while (st2.hasMoreElements()) {
                regardTeam(activeChar, Integer.parseInt(st2.nextToken()), Integer.parseInt(n), Integer.parseInt(id), type);
            }
            showEventControl(activeChar);
