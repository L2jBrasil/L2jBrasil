...
public class AutoAnnouncementHandler {
    protected static Logger _log = LoggerFactory.getLogger(AutoAnnouncementHandler.class);
    ...
    private void restoreAnnouncementData() {
        ...
        try (Connection con = L2DatabaseFactory.getInstance().getConnection();) {
            ...
            statement.close();
            _log.info("GameServer: Loaded {} Auto Announcements.", numLoaded);
        } catch (Exception e) {
        }
    }
    ...
    public AutoAnnouncementInstance registerAnnouncment(String announcementTexts, long announcementDelay) {
        ...
        try (Connection con = L2DatabaseFactory.getInstance().getConnection();) {
            ...
            _log.error("System: Could Not Insert Auto Announcment into DataBase: Duplicate Id", e);
        }
