...
public class LocationVoicedCommand implements IVoicedCommandHandler
{
    ...
    {  
        ...
        else if (getSettings(CommandSettings.class).isLocVoiceCommandEnabled() && !activeChar.inObserverMode() && !activeChar.isInOlympiadMode() && !activeChar.isInDuel() && !activeChar.isInCombat() && !activeChar.isDead() && !activeChar.isInJail()
