...
public class AuctionDao
{
    ...
    private static final String SELECT_AUCTIONS_ENDDATE = "UPDATE auction SET endDate = ? WHERE id = ?";
    ...
    public static ResultSet loadAuctions(Auction auction)
    {
        ResultSet rset = null;
    ...
    public static ResultSet loadBid(Auction auction)
    {
        ResultSet rset = null;
        try (Connection con = L2DatabaseFactory.getInstance().getConnection();
    ...
    {
        try (Connection con = L2DatabaseFactory.getInstance().getConnection();
             PreparedStatement statement = con.prepareStatement(SELECT_AUCTIONS_ENDDATE))
        {
