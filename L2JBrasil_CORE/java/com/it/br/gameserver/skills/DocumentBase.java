...
import com.it.br.gameserver.skills.conditions.*;
...
import com.it.br.gameserver.skills.funcs.*;
...
abstract class DocumentBase {
    static Logger _log = LoggerFactory.getLogger(DocumentBase.class);
            ...
            if (l2jBrasilSettings.isModifySkillDurationEnabled()) {
                ...
                if (skillDuration.containsKey(((L2Skill) template).getId())) {
                    ...
                    if (Config.DEBUG) {
                        ...
                        _log.debug("*** Skill {} ({}) changed duration to {} seconds.", skill.getName(), skill.getLevel(), time);
                    }
                }
