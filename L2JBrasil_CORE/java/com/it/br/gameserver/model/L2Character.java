...
public abstract class L2Character extends L2Object {
     ...
     *
     * @param caster
     * @param skill  <BR><B>Overriden in :</B>  (L2PcInstance)
     */
...
//	private int _floatingRunSpeed;
    ...
    protected void moveToLocation(int x, int y, int z, int offset) {
        ...
        if (Config.DEBUG) _log.debug("distance to target:" + distance);
        ...
        if (offset > 0 || distance < 1) {
            ...
            if (distance < 1 || distance - offset <= 0) {
                ...
                if (Config.DEBUG) _log.debug("already in range, no movement needed.");
        ...
        if (Config.DEBUG) _log.debug("time to target:" + m._ticksToMove);
...
//
    ...
    public void disableAllSkills() {
        if (Config.DEBUG) _log.debug("all skills disabled");
    ...
    public void enableAllSkills() {
        if (Config.DEBUG) _log.debug("all skills enabled");
